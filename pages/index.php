                    ...
                    <div class="row g-0 d-flex align-items-center justify-content-around">
                        <div
                            ...
                            <div class="position-relative">
                                <img data-src="./images/focus/Sachin-Jaltare-Artwork_650x.png" alt="Sachin"
                                    style="width: 200px;height:200px">
                                <div class="focus-absolute">
                                    <img data-src="./images/focus/Sachin-Jaltare-Profile_220x.png" alt="Sachin">
                                </div>
                            </div>
                        ...
                        <div
                            class="col-lg-3 col-md-4 col-sm-8 col-10 d-flex flex-column justify-content-center align-items-center">
                            <div class="position-relative">
                                <img data-src="./images/focus/Sangeeta-Abhay-Artwork_650x.png" alt="Sachin"
                                    style="width: 200px;height:200px">
                                <div class="focus-absolute">
                                    <img data-src="./images/focus/Sangeeta-Abhay-Profile_220x.png" alt="Sachin">
                                </div>
                            </div>
                            <div class="pt-5 d-flex align-items-center justify-content-center flex-column">
                                <div class="py-2">
                        ...
                        <div
                            class="col-lg-3 col-md-4 col-sm-8 col-10 d-flex flex-column justify-content-center align-items-center">
                            <div class="position-relative">
                                <img data-src="./images/focus/Asit-Kumar-Patnaik-Artwork_650x.png" alt="Sachin"
                                    style="width: 200px;height:200px">
                                <div class="focus-absolute">
                                    <img data-src="./images/focus/Asit-Kumar-Patnaik-Profile_220x.png" alt="Sachin">
                                </div>
                            </div>
                            <div class="pt-5 d-flex align-items-center justify-content-center flex-column">
                                <div class="py-2">
                        ...
                        <div
                            class="col-lg-3 col-md-4 col-sm-8 col-10 d-flex flex-column justify-content-center align-items-center">
                            <div class="position-relative">
                                <img data-src="./images/focus/Gurmeet-Marwah-Artwork_650x.png" alt="Sachin"
                                    style="width: 200px;height:200px">
                                <div class="focus-absolute">
                                    <img data-src="./images/focus/Gurmeet-Marwah-Profile_220x.png" alt="Sachin">
                                </div>
                            </div>
                            <div class="pt-5 d-flex align-items-center justify-content-center flex-column">
                                <div class="py-2">
