...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords"
            content="artshoily, <?php echo $sculp['name'] . ', ' . $sculp['users'][0]['first_name'] . ' ' . $sculp['users'][0]['last_name'] ?>">
        <meta name="description" content="<?php echo $sculp['description'] ?>">
        ...
        <meta property="og:url" content="https://www.artshoily.com/view-sculpture" />
        ...
        <link rel="canonical" href="https://artishoily.com/view-sculpture" />
        <link rel="apple-touch-icon" href="https://www.artishoily.com/images/favicon.ico">
        <link rel="icon" type="image/gif" href="../images/favicon.ico">
        <title><?php echo $sculp['name'] ?> | Art Shoily</title>
                    ...
                    <div class="row g-5 d-flex justify-content-center px-2 py-2">
                        <div class="col-lg-8 col-sm-6 col-12">
                            <div class="art-image border border-1 border-secondary shadow w-100 overflow-hidden">
                                <img class="w-100" data-src="../<?php echo $sculp['image']; ?>"
                                    alt="<?php echo $sculp['imgalt'] ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="p-2 bg-secondary-subtle">
                                <h4 class="fw-bold"><?php echo $sculp['name']; ?></h4>
                                <p class="mb-0">
                                    <?php foreach ($sculp['users'] as $user): ?>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <p class="mb-0"><?php echo $sculp['size'] ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td> <span class="text-secondary fs-10px fw-bold">Media</span> </td>
                                            <td>
                                                <p class="mb-0 text-capitalize"><?php echo $sculp['media'] ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td> <span class="text-secondary fs-10px fw-bold">Type</span> </td>
                                            <td>
                                                <p class="mb-0 text-capitalize"><?php echo $sculp['canvas_type'] ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td> <span class="text-secondary fs-10px fw-bold">Frame</span> </td>
                                            <td>
                                                <p class="mb-0 text-capitalize"><?php echo $sculp['frame'] ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <div>
                                            <p class="mb-0">
                                                <span class="text-capitalize fs-8px">
                                                    <?php echo $sculp['currency'] ?>
                                                </span>
                                                <span class="fw-bold">
                                                    <?php echo $sculp['price'] ?>
                                                </span>
                                            </p>
                                        </div>
                        ...
                        <div class="col-md-10 col-12 mt-2 p-2">
                            ...
                            <?php
                            $description = htmlspecialchars($sculp['description']);
